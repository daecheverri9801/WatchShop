...
const submit = () => {
    form.put(route('materials.update', props.materials.id));
};
</script>

<template>

    <Head title="Edit Materials" />

    <AppLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Material</h2>
